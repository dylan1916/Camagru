...
while($d = $req->fetch(PDO::FETCH_OBJ)):
    ...
    // echo "id du membre qui a ajoute l'image";
    // echo $_SESSION['id'];
?>
...
<center>
  ...
  <!-- <form action="" method="POST">
    ...
    <a style="text-decoration:none;" href="add_comment.php?
    id=<?php echo $d->id;?>"><input type="submit" value="Ajouter un commentaire" class="btn btn-outline-primary" name="add_commentaire"></a>
...
while($d = $req->fetch(PDO::FETCH_OBJ)):
    ...
    if (isset($_POST['submit_commentaire']))
    {
        if (isset($_POST['commentaire']) AND !empty($_POST['commentaire']))
        {
            ...
            {
                echo "l'ajout a la bdd est fail";
            }
...
<center>
    ...
    <!-- commentaire -->
    <form action="" method="POST">
        <input name="commentaire" type="text" size="63" placeholder="<?php echo $d->id;?>"><br/><br/>
        <input type="hidden" name="pseudo">
        <input type="submit" value="Valider" class="btn btn-outline-primary" name="submit_commentaire" onclick="myFunction()">
    </form>
    <!-- //// -->
